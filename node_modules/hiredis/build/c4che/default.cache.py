...
CPPPATH_NODE = '/Users/suresh/local/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = '/Users/suresh/.node_libraries'
LIBPATH_HIREDIS = 'default'
LIBPATH_NODE = '/Users/suresh/local/node/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
...
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/suresh/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/suresh/local/node'
